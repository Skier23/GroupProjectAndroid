...
class EventViewModel(application: Application): AndroidViewModel(application){
    ...
    fun refreshEvents(page: Int){
        ...
        disposable =
                RetrofitService.create("https://www.googleapis.com/calendar/v3/calendars/tsletg2ob20o29foc6jgo3835c/").getNowPlaying("f4aa22812bd5c1f8dd1da955d85f2531122dbe88",page).subscribeOn(
