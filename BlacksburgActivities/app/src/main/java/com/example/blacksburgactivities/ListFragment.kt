...
class ListFragment : Fragment() {
    ...
    private lateinit var sample: Button
...
//        initArray(eventItems)
        ...
        sample = view.findViewById(R.id.sample_button)
        sample.setOnClickListener {
            it.findNavController().navigate(R.id.action_listFragment_to_detailFragment, bundleOf(
                "name" to "Title: Demo",
                "date" to "Start Time: May 5 2019, 7:45 am",
                "location" to "Location: classroom",
                "detail" to "Details: Demo this project."
            )
            )
        }
